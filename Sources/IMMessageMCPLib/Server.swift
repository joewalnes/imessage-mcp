...
public func writeJSON(_ obj: [String: Any], to output: FileHandle = .standardOutput) {
    guard let data = try? JSONSerialization.data(withJSONObject: obj, options: []) else { return }
    output.write(data)
    output.write(Data([0x0A])) // '\n'
}

public func errorResponse(id: Any?, code: Int, message: String) -> [String: Any] {
    return [
        "jsonrpc": "2.0",
        "id": id ?? NSNull(),
...
public func successResponse(id: Any?, result: [String: Any]) -> [String: Any] {
    return [
        "jsonrpc": "2.0",
        "id": id ?? NSNull(),
        "result": result,
...
public func toolResult(text: String, isError: Bool = false) -> [String: Any] {
    return [
...
public func readRecentIMessages(hours: Int, limit: Int) throws -> [IMessageRow] {
...
public func sendIMessage(recipient: String, message: String) throws -> String {
...
public func handleInitialize(id: Any?, params: [String: Any]?) {
...
public func handleToolsList(id: Any?) {
    writeJSON(successResponse(id: id, result: ["tools": TOOLS]))
}

public func intArg(_ args: [String: Any], _ key: String, default defaultValue: Int) -> Int {
    if let n = args[key] as? NSNumber { return n.intValue }
    if let s = args[key] as? String, let i = Int(s) { return i }
    return defaultValue
}

public func handleToolsCall(id: Any?, params: [String: Any]?) {
...
public func handleRequest(_ line: String) {
